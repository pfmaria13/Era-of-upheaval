...
btnPage10Choice3.addEventListener("click", () => {
    page11Choice3.style.display = "flex";
    page11Choice3.scrollIntoView({ block: "center", behavior: "smooth" });
    setTimeout(() => {page10.style.display = "none"},700);
});
...
btnPage11Choice3.addEventListener("click", () => {
    page12.style.display = "flex";
    page12.scrollIntoView({ block: "center", behavior: "smooth" });
    setTimeout(() => {page11Choice3.style.display = "none"},700);
    Change_bar(li6, 'is-active', ' is-complete')
    Change_bar(li7, 'in-progress', ' is-active');
    li8.className += ' in-progress'
});
...
btnPage12Choice3.addEventListener("click", () => {
    page13Choice3.style.display = "flex";
    page13Choice3.scrollIntoView({ block: "center", behavior: "smooth" });
    setTimeout(() => {page12.style.display = "none"},700);
});
...
btnPage13Choice3.addEventListener("click", () => {
    page14.style.display = "flex";
    page14.scrollIntoView({ block: "center", behavior: "smooth" });
    setTimeout(() => {page13Choice3.style.display = "none"},700);
    Change_bar(li7, 'is-active', ' is-complete')
    Change_bar(li8, 'in-progress', ' is-active');
    li9.className += ' in-progress'
});
